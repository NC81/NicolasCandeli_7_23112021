...
import { recherche, champsPrincipal } from './recherche.js';
...
export class Affichage {
  ...
  static inscritMotsClesDansTroisFormulaires() {
    ...
    this.inscritMotsClesParFormulaire(ustensilesFiltres, listeUstenciles);
  }
}
export const affichageParDefault = new Affichage('');